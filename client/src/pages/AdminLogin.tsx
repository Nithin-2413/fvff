          ...
          <form onSubmit={handleLogin} className="space-y-3">
            <div className="flex justify-center items-center space-x-3">
              <Input
                ...
                className="h-8 w-24 bg-white/5 backdrop-blur-md border border-white/30 text-white placeholder:text-gray-400 focus:border-white/60 focus:ring-0 focus:bg-white/8 hover:bg-white/6 active:bg-white/8 rounded-lg transition-all duration-300 text-xs text-center shadow-lg font-normal text-shadow-sm"
