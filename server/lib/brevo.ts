...
export async function sendPaymentEmail(params: EmailPaymentParams): Promise<boolean> {
  ...
  try {
    ...
    const paymentContent = `
      ...
      <div style="background:#fff9e6;border-radius:8px;padding:16px;margin:16px 0;border-left:4px solid #f39c12;">
        <p style="margin:0 0 8px;font-size:14px;font-weight:bold;color:#f39c12;">
          💡 Payment Details:
        </p>
